...
public class PatternConfigurationDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtTestRegex.setText("Enter text here to test Regular Expression Pattern");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PatternConfigurationDialog dialog = new PatternConfigurationDialog(new javax.swing.JFrame(), true);

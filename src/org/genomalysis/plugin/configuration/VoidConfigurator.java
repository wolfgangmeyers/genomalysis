...
/**
 * This is meant to be a flag that a PropertySetter does not have
 * a configuration dialog defined...
 * @author ameyers
 */
public class VoidConfigurator
  implements IPropertyConfigurator
{
  ...
  public static VoidConfigurator getInstance()
  {
    ...
    JOptionPane.showMessageDialog(base, "The specified property is not set up for configuration", "Oops!", 2);
        return target;
    }
}

 ...
 * @author  ameyers
 */
public class FilterProgressPanel extends javax.swing.JPanel implements IObserver{
    ...
    public void setFilterProgressControl(FilterProgressControl filterProgressControl) {
    ...
    public void update() {
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                lblSequencesRead.setText(String.valueOf(filterProgressControl.getNumRead()));
                lblSequencesWritten.setText(String.valueOf(filterProgressControl.getNumWritten()));
                lblFilterPassRatio.setText(formatPercentage(filterProgressControl.getPassRatio()));
                lblPercentComplete.setText(formatPercentage(filterProgressControl.getPercentageComplete()));
                lblTotalSequences.setText(String.valueOf(filterProgressControl.getTotalCount()));
                progressBarComplete.setValue(percentageFromRatio(filterProgressControl.getPercentageComplete()));
            }

...
public class GenericListDialog extends JDialog {
    ...
    private JPanel assembleElementPanel(final Property prop, final Object host) {
        ...
        final JLabel indexLabel = new JLabel(String.valueOf(this.elementList
                .size()));
        final JLabel typeLabel = new JLabel(prop.getPropertyValue().getClass()
                .getSimpleName());
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                try {
                    ...
                    if (currentValue == null)
                        DialogHelper.attemptNullPropertyInstantiation(prop,
                                host, container);
                    ...
                    if (currentValue == null) {
                        ...
                        typeLabel.setText(prop.getGetter().getReturnType()
                                .getSimpleName());
                    } else {
                        valueLabel.setText(currentValue.toString());
                        typeLabel.setText(currentValue.getClass()
                                .getSimpleName());
                    }
                    dlg.pack();
    ...
    public void showDialog(List<Object> toBeConfigured, Class<?> genericType) {

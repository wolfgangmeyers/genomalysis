...
public class LegacyCleavageSiteFilter implements IProteinSequenceFilter {
    ...
    public boolean filterProteinSequence(ProteinSequence sequence) {
        ...
        try {
            ...
            bin.close();
            result = (reslt.getMaxC().isAtOrAboveCutoff())
                    && (reslt.getMaxS().isAtOrAboveCutoff())
                    && (reslt.getMaxY().isAtOrAboveCutoff());
